import { NoosphereTopicCreateRequest } from "../client.js";
...
const TopicCreateToolParameters = {
  ...
  properties: {
    ...
    parentId: {
      type: "string",
      description:
        "Optional parent topic ID/UUID. Use noosphere_topics first to find an existing parent.",
...
export function createNoosphereTopicCreateTool(
  rawConfig: unknown,
  ...
  return {
    ...
    description:
      "Create a Noosphere topic or subtopic. Requires an ADMIN-scoped Noosphere API key. Use this when noosphere_article_create needs a topicId and the appropriate topic does not exist yet.",
...
function normalizeTopicCreateParams(rawParams: unknown): NoosphereTopicCreateRequest {
