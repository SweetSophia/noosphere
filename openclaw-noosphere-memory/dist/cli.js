...
import { isRecord, readBoolean, readStringArray, redactSecret, resolveNoosphereMemoryConfig, } from "./config.js";
...
const VERIFIED_INSTALLER_REF = "5c84a170a5b48754791e57b7e98191df5fbed5b8";
const VERIFIED_INSTALLER_SHA256 = "1b98ea75fbcc15d224d4ab188d6f6958380321d98dc412816e3780937473e951";
const VERIFIED_NOOSPHERE_VERSION = "1.13.3";
...
export async function buildNoosphereStatusReport(rawConfig, rootConfig, options = {}) {
...
export async function buildNoosphereDoctorReport(rawConfig, rootConfig, options = {}) {
    const config = resolveNoosphereMemoryConfig(rawConfig, process.env, rootConfig);
    const checks = [];
...
function printStatusReport(report, json) {
    if (json) {
