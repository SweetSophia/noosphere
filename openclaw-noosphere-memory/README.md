...
Keep this variable with the API key in the service environment or another
administrator-controlled secret/configuration source. Do not put it in plugin
configuration: an actor able to change `config.baseUrl` must not also be able to
