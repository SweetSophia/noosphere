...
| `NOOSPHERE_BOOTSTRAP_SECRETS_FILE` | `/tmp/noosphere-bootstrap-secrets.json` | Container path where bootstrap writes any auto-generated admin/API credentials with mode `0600`; logs include only this path, not the secret values. |
