...
```bash
curl -fsSL https://raw.githubusercontent.com/SweetSophia/noosphere/cd2f509a737a55c2cd53f027cf90e1be8865d30d/install.sh | bash
```
...
(
  ...
  curl -fsSL https://raw.githubusercontent.com/SweetSophia/noosphere/cd2f509a737a55c2cd53f027cf90e1be8865d30d/install.sh -o "$installer"
  printf '%s  %s\n' '4fb73323c30e8de0ccbef473329285ad8b6952b62e097bf27dfbdaba3ca9d575' "$installer" | sha256sum -c -
  bash "$installer"
)
```
