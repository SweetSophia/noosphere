...
```bash
npm install -g @sweetsophia/kilocode-noosphere-memory@1.14.0
...
{
  "plugin": [
    "@sweetsophia/kilocode-noosphere-memory@1.14.0"
  ]
}
```
...
```bash
kilo plugin @sweetsophia/kilocode-noosphere-memory@1.14.0 --global
```
