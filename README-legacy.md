...
```bash
npm install -g @sweetsophia/kilocode-noosphere-memory@1.13.3
...
{
  "plugin": [
    "@sweetsophia/kilocode-noosphere-memory@1.13.3"
  ]
}
```
...
```bash
kilo plugin @sweetsophia/kilocode-noosphere-memory@1.13.3 --global
```
