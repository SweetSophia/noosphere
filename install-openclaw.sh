...
# run below.
export NOOSPHERE_VERSION NOOSPHERE_PORT NOOSPHERE_IMAGE APP_URL BIND_ADDRESS POSTGRES_PASSWORD NEXTAUTH_SECRET REDIS_URL NOOSPHERE_MEMORY_RECALL_RATE_LIMIT_PER_MINUTE
